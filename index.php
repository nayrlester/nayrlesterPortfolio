...
<head>
  ...
  <script src="https://kit.fontawesome.com/a200de2797.js" crossorigin="anonymous"></script>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      <span class="d-block d-lg-none">Ryan Lester Bulot</span>
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        <h1 class="mb-0">Nayr
          <span class="text-primary">Lester</span>
        </h1>
        <div class="subheading mb-5">Website : 
          <a href="https://nayrlester-portfolio.herokuapp.com"> nayrlester-portfolio.herokuapp.com</a>
        </div>
        <p class="lead mb-5">I am experienced in leveraging agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.</p>
        <div class="social-icons">
          <a href="https://github.com/nayrlester">
            <i class="fab fa-github"></i>
          </a>
          <a href="https://www.linkedin.com/in/nayrlester2903">
            <i class="fab fa-linkedin"></i>
          </a>
          <a href="https://web.facebook.com/nayrlester2903">
      ...
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            ...
            <div class="subheading mb-3">cushyfy Solutions</div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">Associate Web Engineer</h3>
            <div class="subheading mb-3">Jump Digital Inc.</div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">Node.js Developer</h3>
            <div class="subheading mb-3">OutWorks.com</div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">Colegio de San Gabriel Arcangel</h3>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">St. Mary's Academy</h3>
            <div class="subheading mb-3">Secondary Level</div>
            <!-- <p>GPA: 3.56</p> -->
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary">June 2002 - May 2006</span>
          </div>
        </div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="interests">
      <div class="w-100">
        ...
        <p>Apart from being a web developer, I enjoy most of my time with my family. I also like playing Basketball and Computer games like dota.</p>
        <p class="mb-0">When forced indoors, I just want to watch movies with my family and play mobile legends in my cellphone.</p>
      </div>
    </section>
